...
export default function EstoqueMedicamentos() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (!editando) {
                ...
                const dadosEnvio = {
                    categoria: 'estoque_medicamentos',
                ...
                await cadastrarDocPublicacao(dadosEnvio, 'estoque_medicamentos')
                toast.success('Estoque de medicamentos cadastrado com sucesso!')
            } else {
                ...
                toast.success('Estoque de medicamentos atualizado com sucesso!')
            }
    ...
    const acoes = [
        ...
        {
            nome: <FaDownload size={28} className="text-azul_escuro transition-colors" />,
        ...
        <section className="flex flex-col flex-grow overflow-auto text-azul_escuro gap-4 bg-gradient-to-br from-gray-200 to-gray-300 p-4">
                ...
                {mostrarFormulario ? (
                    <>
                        <h1 className="text-lg font-bold mb-4">
                            Cadastro de Estoque de Medicamentos
                        </h1>
                    ...
                    <>
                        <h1 className="text-lg font-bold mb-4">Estoque de Medicamentos</h1>
            ...
            {modalEdicao && registroSelecionado && (
                <Modal
                    ...
                    title={`Editar Estoque - ${registroSelecionado.titulo}`}
                >
