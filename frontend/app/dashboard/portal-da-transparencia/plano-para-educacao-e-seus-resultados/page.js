...
export default function PlanoParaEducacaoESeusResultados() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (!editando) {
                ...
                const dadosEnvio = {
                    categoria: 'plano_educacao_resultados',
                ...
                await cadastrarDocPublicacao(dadosEnvio, 'plano_educacao')
                toast.success('Plano de educação cadastrado com sucesso!')
            } else {
                // Editar documento existente
                const dadosEnvio = {
                    categoria: 'plano_educacao',
                    dataPublicacao: formData.dataPublicacao,
                    titulo: formData.titulo,
                    descricao: formData.descricao,
                    arquivo: formData.arquivo
                ...
                toast.success('Plano de educação atualizado com sucesso!')
            }
        ...
        <section className="flex flex-col flex-grow overflow-auto text-azul_escuro gap-4 bg-gradient-to-br from-gray-200 to-gray-300 p-4">
                ...
                {mostrarFormulario ? (
                    <>
                        <h1 className="text-lg font-bold mb-4">
                            Cadastro de Plano para Educação e Seus Resultados
                        </h1>
                    ...
                    <>
                        <h1 className="text-lg font-bold mb-4">Plano para Educação e Seus Resultados</h1>
            ...
            {modalEdicao && registroSelecionado && (
                <Modal
                    ...
                    title={`Editar Plano de Educação - ${registroSelecionado.titulo}`}
                >
