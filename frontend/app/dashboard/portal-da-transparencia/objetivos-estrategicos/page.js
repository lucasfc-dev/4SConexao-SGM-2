    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (!editando) {
                ...
                const dadosEnvio = {
                    categoria: 'objetivos_estrategicos',
                ...
                await cadastrarDocPublicacao(dadosEnvio, 'objetivos_estrategicos')
                toast.success('Objetivo estratégico cadastrado com sucesso!')
            } else {
            ...
            toast.error('Erro ao salvar objetivo: ' + error.message)
            console.error(error)
        } finally {
            setLoading(false)
        }
        ...
        <section className="flex flex-col flex-grow overflow-auto text-azul_escuro gap-4 bg-gradient-to-br from-gray-200 to-gray-300 p-4">
            ...
            <div className="flex flex-col w-full mx-auto bg-white shadow-lg rounded-lg p-4">
                {mostrarFormulario ? (
                    ...
                    <>
                        <h1 className="text-lg font-bold mb-4">Objetivos Estratégicos</h1>
            ...
            {modalEdicao && registroSelecionado && (
                <Modal
                    ...
                    title={`Editar Objetivo Estratégico - ${registroSelecionado.titulo}`}
                >
