...
export default function ListaDeEsperaRegulacao() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (!editando) {
                ...
                const dadosEnvio = {
                    categoria: 'lista_espera_regulacao',
                ...
                await cadastrarDocPublicacao(dadosEnvio, 'lista_espera_regulacao')
                ...
                {mostrarFormulario ? (
                    <>
                        <h1 className="text-lg font-bold mb-4">
                            Cadastro de Lista de Espera de Regulação
                        </h1>
                    ...
                    <>
                        <h1 className="text-lg font-bold mb-4">Lista de Espera de Regulação</h1>
