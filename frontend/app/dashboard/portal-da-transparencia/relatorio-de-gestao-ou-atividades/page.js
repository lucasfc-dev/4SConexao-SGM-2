...
export default function RelatorioDeGestaoOuAtividades() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (!editando) {
                ...
                await cadastrarDocPublicacao(dadosEnvio, 'relatorio_gestao')
                toast.success('Relatório de gestão cadastrado com sucesso!')
            } else {
                ...
                toast.success('Relatório de gestão atualizado com sucesso!')
            }
            ...
            toast.error('Erro ao salvar relatório de gestão: ' + error.message)
            console.error(error)
        } finally {
            setLoading(false)
        }
        ...
        <section className="flex flex-col flex-grow overflow-auto text-azul_escuro gap-4 bg-gradient-to-br from-gray-200 to-gray-300 p-4">
                ...
                {mostrarFormulario ? (
                    <>
                        <h1 className="text-lg font-bold mb-4">
                            Cadastro de Relatório de Gestão ou Atividades
                        </h1>
                    ...
                    <>
                        <h1 className="text-lg font-bold mb-4">Relatório de Gestão ou Atividades</h1>
            ...
            {modalEdicao && registroSelecionado && (
                <Modal
                    ...
                    title={`Editar Relatório de Gestão - ${registroSelecionado.titulo}`}
                >
