...
const CATEGORIA = 'conselho_assistencia_social'

export default function ConselhoMunicipalAssistenciaSocial() {
    ...
    return (
        <section className="flex flex-col flex-grow overflow-auto text-azul_escuro gap-4 bg-gradient-to-br from-gray-200 to-gray-300 p-4">
            ...
            <div className="flex flex-col w-full mx-auto bg-white shadow-lg rounded-lg p-4">
                {mostrarFormulario ? (
                    <>
                        <h1 className="text-lg font-bold mb-4">Cadastro de Documentos - Conselho Municipal de Assistência Social</h1>
                    ...
                    <>
                        <h1 className="text-lg font-bold mb-4">Documentos - Conselho Municipal de Assistência Social</h1>
