...
export default function ListaDeEsperaDasCrechesMunicipais() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (!editando) {
                ...
                const dadosEnvio = {
                    categoria: 'lista_espera_creches_municipais',
                ...
                await cadastrarDocPublicacao(dadosEnvio, 'lista_espera_creches')
                toast.success('Lista de espera cadastrada com sucesso!')
            } else {
                ...
                toast.success('Lista de espera atualizada com sucesso!')
            }
        ...
        <section className="flex flex-col flex-grow overflow-auto text-azul_escuro gap-4 bg-gradient-to-br from-gray-200 to-gray-300 p-4">
                ...
                {mostrarFormulario ? (
                    <>
                        <h1 className="text-lg font-bold mb-4">
                            Cadastro de Lista de Espera das Creches Municipais
                        </h1>
                    ...
                    <>
                        <h1 className="text-lg font-bold mb-4">Lista de Espera das Creches Municipais</h1>
            ...
            {modalEdicao && registroSelecionado && (
                <Modal
                    ...
                    title={`Editar Lista de Espera - ${registroSelecionado.titulo}`}
                >
