...
export default function PlanoParaSaudeESeusResultados() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (!editando) {
                ...
                await cadastrarDocPublicacao(dadosEnvio, 'plano_saude')
        ...
        <section className="flex flex-col flex-grow overflow-auto text-azul_escuro gap-4 bg-gradient-to-br from-gray-200 to-gray-300 p-4">
                ...
                {mostrarFormulario ? (
                    <>
                        <h1 className="text-lg font-bold mb-4">
                            Cadastro de Plano para Saúde e Seus Resultados
                        </h1>
                    ...
                    <>
                        <h1 className="text-lg font-bold mb-4">Plano para Saúde e Seus Resultados</h1>
            ...
            {modalEdicao && registroSelecionado && (
                <Modal
                    ...
                    title={`Editar Plano de Saúde - ${registroSelecionado.titulo}`}
                >
