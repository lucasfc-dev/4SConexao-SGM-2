...
export default function TabelaDeValoresDiarias() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (!editando) {
                ...
                const dadosEnvio = {
                    categoria: 'tabela_valores_diarias',
                ...
                await cadastrarDocPublicacao(dadosEnvio, 'tabela_valores_diarias')
                toast.success('Tabela de valores de diárias cadastrada com sucesso!')
            } else {
                ...
                toast.success('Tabela de valores de diárias atualizada com sucesso!')
            }
        ...
        <section className="flex flex-col flex-grow overflow-auto text-azul_escuro gap-4 bg-gradient-to-br from-gray-200 to-gray-300 p-4">
                ...
                {mostrarFormulario ? (
                    <>
                        <h1 className="text-lg font-bold mb-4">
                            Cadastro de Tabela de Valores de Diárias
                        </h1>
                    ...
                    <>
                        <h1 className="text-lg font-bold mb-4">Tabela de Valores de Diárias</h1>
            ...
            {modalEdicao && registroSelecionado && (
                <Modal
                    ...
                    title={`Editar Tabela de Valores - ${registroSelecionado.titulo}`}
                >
