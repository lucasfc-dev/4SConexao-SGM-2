    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (!editando) {
                ...
                await cadastrarDocPublicacao(dadosEnvio, 'lei_paulo_gustavo')
        ...
        <section className="flex flex-col flex-grow overflow-auto text-azul_escuro gap-4 bg-gradient-to-br from-gray-200 to-gray-300 p-4">
                ...
                {mostrarFormulario ? (
                    <>
                        <h1 className="text-lg font-bold mb-4">
                            Cadastro de Lei Paulo Gustavo – LPG
                        </h1>
                    ...
                    <>
                        <h1 className="text-lg font-bold mb-4">Lei Paulo Gustavo – LPG</h1>
            ...
            {modalEdicao && registroSelecionado && (
                <Modal
                    ...
                    title={`Editar Lei Paulo Gustavo – LPG - ${registroSelecionado.titulo}`}
                >
