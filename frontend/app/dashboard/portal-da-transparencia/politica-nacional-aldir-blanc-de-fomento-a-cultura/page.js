...
export default function PoliticaNacionalAldirBlanc() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (!editando) {
                ...
                const dadosEnvio = {
                    categoria: 'politica_nacional_abfc',
                ...
                await cadastrarDocPublicacao(dadosEnvio, 'politica_nacional_abfc')
                toast.success('Documento cadastrada com sucesso!')
            } else {
        ...
        <section className="flex flex-col flex-grow overflow-auto text-azul_escuro gap-4 bg-gradient-to-br from-gray-200 to-gray-300 p-4">
                ...
                {mostrarFormulario ? (
                    <>
                        <h1 className="text-lg font-bold mb-4">
                            Cadastro de Política Nacional Aldir Blanc
                        </h1>
                    ...
                    <>
                        <h1 className="text-lg font-bold mb-4">Política Nacional Aldir Blanc de Fomento à Cultura</h1>
            ...
            {modalEdicao && registroSelecionado && (
                <Modal
                    ...
                    title={`Editar Política Nacional Aldir Blanc - ${registroSelecionado.titulo}`}
                >
