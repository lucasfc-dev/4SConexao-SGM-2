...
export default function HorariosDosProfissionaisDaSaude() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (!editando) {
                ...
                const dadosEnvio = {
                    categoria: 'horarios_profissionais_saude',
                ...
                await cadastrarDocPublicacao(dadosEnvio, 'horarios_profissionais_saude')
        ...
        <section className="flex flex-col flex-grow overflow-auto text-azul_escuro gap-4 bg-gradient-to-br from-gray-200 to-gray-300 p-4">
                ...
                {mostrarFormulario ? (
                    <>
                        <h1 className="text-lg font-bold mb-4">
                            Cadastro de Horários dos Profissionais da Saúde
                        </h1>
                    ...
                    <>
                        <h1 className="text-lg font-bold mb-4">Horários dos Profissionais da Saúde</h1>
            ...
            {modalEdicao && registroSelecionado && (
                <Modal
                    ...
                    title={`Editar Horários - ${registroSelecionado.titulo}`}
                >
