...
export default function ListaDeTerceirizados() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (!editando) {
                ...
                await cadastrarDocPublicacao(dadosEnvio, 'lista_terceirizados')
                toast.success('Lista de terceirizados cadastrada com sucesso!')
            } else {
                ...
                toast.success('Lista de terceirizados atualizada com sucesso!')
            }
            ...
            toast.error('Erro ao salvar lista de terceirizados: ' + error.message)
            console.error(error)
        } finally {
            setLoading(false)
        }
    ...
    const handleDeletar = async (registro) => {
        if (window.confirm('Tem certeza que deseja deletar este documento?')) {
            try {
                ...
                await recarregarRegistros(filtros, paginaAtualfiltros, paginaAtual)
        ...
        <section className="flex flex-col flex-grow overflow-auto text-azul_escuro gap-4 bg-gradient-to-br from-gray-200 to-gray-300 p-4">
                ...
                {mostrarFormulario ? (
                    <>
                        <h1 className="text-lg font-bold mb-4">
                            Cadastro de Lista de Terceirizados
                        </h1>
                    ...
                    <>
                        <h1 className="text-lg font-bold mb-4">Lista de Terceirizados</h1>
            ...
            {modalEdicao && registroSelecionado && (
                <Modal
                    ...
                    title={`Editar Lista de Terceirizados - ${registroSelecionado.titulo}`}
                >
