...
export default function ListaDeEstagiarios() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (!editando) {
                ...
                await cadastrarDocPublicacao(dadosEnvio, 'lista_estagiarios')
                toast.success('Lista de estagiários cadastrada com sucesso!')
            } else {
                ...
                toast.success('Lista de estagiários atualizada com sucesso!')
            }
            ...
            toast.error('Erro ao salvar lista de estagiários: ' + error.message)
            console.error(error)
        } finally {
            setLoading(false)
        }
        ...
        <section className="flex flex-col flex-grow overflow-auto text-azul_escuro gap-4 bg-gradient-to-br from-gray-200 to-gray-300 p-4">
                ...
                {mostrarFormulario ? (
                    <>
                        <h1 className="text-lg font-bold mb-4">
                            Cadastro de Lista de Estagiários
                        </h1>
                    ...
                    <>
                        <h1 className="text-lg font-bold mb-4">Lista de Estagiários</h1>
            ...
            {modalEdicao && registroSelecionado && (
                <Modal
                    ...
                    title={`Editar Lista de Estagiários - ${registroSelecionado.titulo}`}
                >
